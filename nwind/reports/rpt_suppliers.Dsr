VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpt_suppliers 
   Caption         =   "Suppliers"
   ClientHeight    =   6330
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9180
   Icon            =   "rpt_suppliers.dsx":0000
   ...
   EndProperty
End
Attribute VB_Name = "rpt_suppliers"
