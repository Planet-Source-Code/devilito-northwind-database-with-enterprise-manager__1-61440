...
Begin VB.Form frm_customers 
   ...
   Begin osenxpsuite2005.OsenXPButton cmdCancel 
      ...
      MCOL            =   16711935
      MPTR            =   0
      MICON           =   "frm_customers.frx":0724
      PICN            =   "frm_customers.frx":0740
      UMCOL           =   -1  'True
   ...
   Begin osenxpsuite2005.OsenXPButton cmdOK 
      ...
      MCOL            =   16711935
      MPTR            =   0
      MICON           =   "frm_customers.frx":0CDA
      PICN            =   "frm_customers.frx":0CF6
      UMCOL           =   -1  'True
      XPBlendPicture  =   -1  'True
      GradientColor   =   -1  'True
      GradientColor1  =   16777215
...
Private Sub Form_Load()
    ...
    If IsNew Then
        mStrSQL = "select * from customers where false"
    Else
        mStrSQL = "select * from customers where customerid='" & KeyValue & "'"
    End If
