...
Begin VB.Form frm_user_mgmt 
   ...
   Begin osenxpsuite2005.OsenXPTab MyTab 
      ...
      TabText1        =   "User Info"
      TabEnabled1     =   -1  'True
      TabPicture1     =   "frm_user_mgmt.frx":058A
      TabBack21       =   16777215
      TabCountCtls1   =   11
      ...
      Begin osenxpsuite2005.OsenXPLabel LblGetNodes 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frm_user_mgmt.frx":08DC
         MousePointer    =   99
         Picture         =   "frm_user_mgmt.frx":0A3E
         ...
         AutoSize        =   0   'False
         PictureOver     =   "frm_user_mgmt.frx":0DD8
      End
      Begin osenxpsuite2005.OsenXPButton cmdOK 
         ...
         MCOL            =   16711935
         MPTR            =   99
         MICON           =   "frm_user_mgmt.frx":1172
         PICN            =   "frm_user_mgmt.frx":12D4
         UMCOL           =   -1  'True
      ...
      Begin osenxpsuite2005.OsenXPButton cmdCancel 
         ...
         MCOL            =   16711935
         MPTR            =   99
         MICON           =   "frm_user_mgmt.frx":186E
         PICN            =   "frm_user_mgmt.frx":19D0
         UMCOL           =   -1  'True
         XPBlendPicture  =   -1  'True
         GradientColor   =   -1  'True
         GradientColor1  =   16777215
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin osenxpsuite2005.OsenXPLabel OsenXPLabel2 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frm_user_mgmt.frx":1F6A
            MousePointer    =   99
            Caption         =   "Photo 3x4"
            ForeColor       =   0
            Alignment       =   1
         ...
         Begin VB.Image ImgPhoto 
            Height          =   1635
            Left            =   90
            MouseIcon       =   "frm_user_mgmt.frx":20CC
      ...
      Begin osenxpsuite2005.OsenXPLabel LblDetail 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "frm_user_mgmt.frx":221E
         MousePointer    =   99
         Picture         =   "frm_user_mgmt.frx":2380
         ForeColorOver   =   12582912
         ForeColorDown   =   33023
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image2 
         Height          =   480
         Left            =   8460
         Picture         =   "frm_user_mgmt.frx":291A
         Top             =   150
         Width           =   480
      End
   End
...
'    Shape1.BorderColor = tvwMain.GradientColor2
    ...
    SmallIcons.OpenImagesCollection App.Path & "\icons\smallicons.img"
...
On Error Resume Next
    ...
    Flags = 1
    PopupMenu mnuCheckAll, , X + lvwPrivileges.Left, lvwPrivileges.Top + Y
    If Flags <> 1 Then
        lvwPrivileges.CheckAll Index, Flags
    End If
...
On Error Resume Next
    ...
    ' Set Filter
    cdlg.Filter = "All Picture File|*.bmp;*.jpg;*.jpeg;*.png;*.gif"
    
    cdlg.DefaultExt = "bmp"
    
    cdlg.DialogTitle = "Open Picture ..."
